...
(function($) {
    ...
    function initScreen(obj,opts)
    {
        ...
        obj.append(
            $("<div></div>").attr("id",obj.attr("id")+"_title_box").css({"position":"absolute","color":obj.css("color"),"text-align":"center","font-weight":"bold","width":obj.width(),"height":150,"top":(obj.height()/2)-75})
                .append(
                    $("<div></div>").attr("id",obj.attr("id")+"_title").css({"font-size":100}).html(""))
                .append(
                    $("<div></div>")
    ...
    $.fn.pong.defaults = {
        ...
        "pad_color": "#003a5d",          // Couleur des paddles
        "ball_size": 10,                 // Taille de la balle
        "ball_color": "#003a5d",         // Couleur de la balle
        "font_family": "Courier,Impact", // Police
        "font_color": "#003a5d",         // Couleur du texte
        "border_color": "#003a5d",       // Couleur des bordures de l'écran de jeu
